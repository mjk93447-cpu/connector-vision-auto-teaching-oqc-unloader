...
| 데이터 | TP | FP | FN | Recall | Precision | F1 |
|--------|-----|-----|-----|--------|------------|-----|
| 테스트 20장 (기하학적 refinement 적용) | 800 | 0 | 0 | **100%** | **100%** | **100%** |
| 테스트 20장 (refinement 미적용) | 757 | 43 | 43 | 94.62% | 94.62% | 94.62% |

- **기하학적 제약 활용**: 20+20 고정, 균일 간격 보간, Y밴드 필터, 빈 행 템플릿(ROADMAP 10.6, 10.7)
- **FP on fake (노이즈)**: 0건
- **추론 속도**: ~400 ms/img (CPU, 모델 캐싱 + refinement)
